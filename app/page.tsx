...
export default function HomePage() {
  return (
    <>
        ...
        <section className="hero">
          <div className="shell hero-grid">
            <div>
              ...
              <h1>نصٌّ أدق.<br /><em>سياقٌ أتم.</em></h1>
      ...
      <footer className="site-footer"><div className="shell footer-inner"><span>نَضِيد — محرر العربية الذكي</span><span>نصٌّ أدق. سياقٌ أتم.</span></div></footer>
    </>
  );
}
